...
//Arrays
var wordArray = ["three", "foul", "lebron", "cavs", "lakers", "free throw", "dribble", "basketball",
   "pass", "shoot", "score", "block", "steal", "turnover",]

var gameStatus = false;
var randomNumber = Math.floor(Math.random() * wordArray.length);
var word = wordArray[randomNumber];
var lettersRemaining = word.length;
var answerArray = []; 


//Use key events to listen for the letters.
...
function displayAnswer() {
    ...
    revealedAnswerDisplay.textContent = word.toUpperCase();
}
...
function init() {
    ...
    //Apply new randomNumber to obtain random word .
    word = wordArray[randomNumber].word;
    ...
    for (var i = 0; i < word.length; i++) {
        //If an answer has more than one word, use + as a separator. 
        if (word[i] === "+") {
            answerArray[i] = "&nbsp;";
        } else {
